...
## Project Organization
    ...
    │                         so colocacion_de_creditos can be imported.
    │
    └── colocacion_de_creditos   <- Source code for use in this project.
        │
        ├── __init__.py             <- Makes colocacion_de_creditos a Python module.
        │
